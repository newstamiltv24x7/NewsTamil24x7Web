            ...
            >
              ...
              >
                {loader ? (
                  ...
                  <Box overflow={"hidden"} height={380} borderRadius={"6px"}>
                    {newsList?.at(0)?.youtube_embed_id === "" ? (
                      ...
                      <iframe
                        width="100%"
                        height="100%"
                        src={`${(newsList?.at(0)?.youtube_embed_id || "").split("?")[0]}?rel=0`}
              ...
              newsList?.slice(3, newsList?.length)?.map((list, index) => (
                <Grid item xs={12} sm={12} md={4} key={list?._id}>
                  <Box
                    ...
                    pr={1.2}
                  >
                    <CardSection data={list} cardHeight={168} viewControl={viewControl} />
                    <Box display={"grid"} sx={{ placeItems: "center" }}>
                      <hr
                        style={{
                          width: "97%",
