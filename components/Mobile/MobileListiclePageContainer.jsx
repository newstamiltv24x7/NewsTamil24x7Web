...
import MobileListiclePage from "./MobileListiclePage";

function MobileListiclePageContainer({ newsData, trendData, listicleRes ,viewControl }) {
  const NewsArr = newsData?.at(0)?.data;
  const TRENDING = trendData?.at(0)?.data ?? [];
  return (
    <Box maxWidth={1440} px={2} margin={"auto"} mt={21}>
      <Grid container spacing={3}>
        ...
        sm={12}
        >
          <MobileListiclePage listicleRes={listicleRes} />
        </Grid>
        <Grid item 
          md={12}
          xs={12}
...
export default MobileListiclePageContainer;
