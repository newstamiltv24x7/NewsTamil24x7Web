...
import MobileLiveBlog from "./MobileLiveBlog";

function MobileLiveBlogPageContainer({ newsData, trendData, liveBlogData, viewControl }) {
    ...
    <Box maxWidth={1440} px={2} margin={"auto"} mt={21}>
      <Grid container spacing={3}>
        <Grid item 
          ...
          xs={12}
          sm={12}>
          <MobileLiveBlog liveBlogData={liveBlogData} />
        </Grid>
        <Grid  item
          md={12}
          xs={12}
...
export default MobileLiveBlogPageContainer;
