...
function WebStoryPageContainer({
  menuData,
  trendingData,
  breakingData,
  quickControl,
  ...
  const WebStoriesData = webStoryData ?? [];
          ...
          <Grid item xs={9}>
            ...
            <Grid container spacing={1}>
              {Array.isArray(WebStoriesData) &&
                WebStoriesData?.slice(0, 15)?.map((data) => (
                      ...
                      <Box position={"relative"}>
                        ...
                        replace>
                          ...
                          fetchPriority="high" rel="preload"
                            src={data?.c_web_story_cover_img}
                            alt="web-stories-data"
                            width={100}
                            unoptimized
                            height={105}
                            style={{
                        ...
                        >
                          ...
                          <Typography
                            ...
                            sx={{ color: "#fff" }}
                          >
                            {`+ ${data?.c_web_story_images?.length} ${
                              data?.c_web_story_images?.length > 0
                                ? "Images"
                                : "Image"
                            }`}
                          </Typography>
...
export default WebStoryPageContainer;
