      ...
      text: (
        ...
        >
          <BiSolidAnalyse
            ...
            style={{ position: "relative", top: 3, marginRight: 12 }}
          />
          <b>Application</b> refers to News Tamil 24x7, the software program
    ...
    },
    {
      ...
      text: (
        ...
        >
          ...
          "Our" in this Agreement) refers to Corporation, 145, 1-A, Rukmani
          Lakshmipathi Rd, Egmore, Chennai, Tamil Nadu 600008.
        </p>
      ),
    },
    {
  ...
  const content = (
    <>
      ...
      >
        ...
        {Definitions.map((list) => list.text)}
      </Box>
      <Box px={2} maxWidth={1440} mx={"auto"}>
        ...
        {[
          ...
          <p
            style={{
              fontWeight: index === 0 || index === 4 || index === 8 ? 600 : 500,
              fontFamily: "var(--anek-font)",
              wordSpacing: 2,
              fontSize: 18,
            }}
        ...
        >
          ...
          Service users is among the assets transferred. Us.
        </p>
        <p
          style={{
            fontWeight: 600,
        ...
        >
          ...
          >
            ...
            />
            By email:{" "}
            <Link href="mailto:newstamiltv24x7@gmail.com">
              newstamiltv24x7@gmail.com
            </Link>
          </p>
        </Box>
      </Box>
